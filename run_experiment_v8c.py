"""V8c: v7c plus a recursive shared-parameter hyperbolic time hierarchy."""
...
experiment.USE_RECURSIVE_TEMPORAL_HIERARCHY = True
experiment.RECURSIVE_TEMPORAL_FACTORS = (2, 2, 2)
experiment.RESULT_FILENAME = "experiment_results_v8c_recursive_temporal.json"
