...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, src_mask=None, src_key_padding_mask=None, is_causal=None):
        # Handle is_causal parameter if passed in newer PyTorch versions
        if is_causal is not None:
            # For compatibility, we ignore is_causal since our implementation doesn't use causal masking
            pass
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask=None, memory_mask=None, tgt_key_padding_mask=None, memory_key_padding_mask=None, tgt_is_causal=None, memory_is_causal=None):
        # Handle *_is_causal parameters if passed in newer PyTorch versions
        if tgt_is_causal is not None or memory_is_causal is not None:
            # For compatibility, we ignore causal parameters since our implementation doesn't use them
            pass
